...
function build(experience: ExperienceRecord): SceneFlow {
  ...
  const scenes: SceneStep[] = [
    {
      id: "mind-read",
      background: { type: "pulse-glow", gradient: "from-[#0d0d1a] via-[#1a102e] to-[#0a0512]", color: "rgba(180,130,255,0.12)" },
    ...
    },
    {
      ...
      interaction: { type: "auto", action: "next", label: "", delay: 1800 },
      reaction: "✨",
    },
    {
      id: "three",
    ...
    {
      id: "two",
      background: { type: "pulse-glow", gradient: "from-[#0d0d1a] via-[#1a102e] to-[#0a0512]", color: "rgba(255,95,183,0.15)" },
      prop: { type: "sparkle", animation: "pulse" },
      content: { title: "2" },
      interaction: { type: "auto", action: "next", label: "", delay: 700 },
    },
    ...
    {
      id: "reveal-vision",
      background: { type: "pulse-glow", gradient: "from-[#1c0824] via-[#2d1040] to-[#14041a]", color: "rgba(255,95,183,0.25)" },
      prop: { type: "sparkle", animation: "float" },
    ...
    {
      id: "dont-chase",
      background: { type: "pulse-glow", gradient: "from-[#1c0824] via-[#2d1040] to-[#14041a]", color: "rgba(180,130,255,0.12)" },
      prop: { type: "sparkle", animation: "float" },
      content: {
    ...
    {
      id: "yes-no",
      background: { type: "pulse-glow", gradient: "from-[#1c0824] via-[#2d1040] to-[#14041a]", color: "rgba(255,95,183,0.2)" },
      prop: { type: "sparkle", animation: "float" },
      content: {
        title: "You love me? 💕",
