...
const csp = [
  `default-src 'self'`,
  `script-src 'self' 'unsafe-eval' 'unsafe-inline' https://www.googletagmanager.com https://www.highperformanceformat.com https://*.highperformanceformat.com https://*.effectivecpmnetwork.com https://*.adsterra.com https://*.trafficfactory.com https://*.profitablecreativeformat.com https://*.furiousexpansion.com`,
